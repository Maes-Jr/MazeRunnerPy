# Module 4 : Algorithme de Résolution BFS avec Visualisation

Voici une implémentation complète du module 4 qui s'intègre parfaitement avec les autres modules du projet, en respectant les conventions de codage françaises :
